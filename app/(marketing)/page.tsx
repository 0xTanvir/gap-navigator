...
import HomeButtonSection from "@/components/home/home-button-section";
        ...
        >
          ...
          <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
            ...
            <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
              Conduct audits with ease, whether it's on-site or remotely. Create customized assessments tailored to your
              needs.
            </p>
          </div>
          ...
          <div className="mx-auto grid justify-center gap-4 grid-cols-1 md:grid-cols-2 max-w-[64rem]">
            <div className="md:order-1 order-2 relative overflow-hidden rounded-lg p-2">
              <div className="flex flex-col justify-between rounded-md p-6">
                ...
                <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
                  Consultants can share multiple audits with clients, fostering collaboration and enhancing the audit
                  experience.
                </p>
              </div>
            </div>
          ...
          <div className="mx-auto grid justify-center gap-4 grid-cols-1 md:grid-cols-2 max-w-[64rem]">
            ...
            <div className="relative overflow-hidden rounded-lg p-2">
              <div className="flex flex-col justify-between rounded-md p-6">
                ...
                <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
                  Unlock the power of data with our comprehensive reports. Gain valuable insights to drive informed
                  decisions.
                </p>
              </div>
            </div>
