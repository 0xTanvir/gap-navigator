...
import {TeamCardProps} from "@/types/dto";

const TeamCard: React.FC<TeamCardProps> = ({imageSrc, name, profession, facebookLink, twitterLink, instagramLink}) => {
    return (
        <>
              ...
              >
                ...
                />
                    ...
                    <div className="text-center">
                        <h4 className="text-dark mb-2 text-lg font-medium">{name}</h4>
                        <p className="text-body-color mb-5 text-sm font-medium">
                            {profession}
                        </p>
                        <div className="flex items-center justify-center">
                            <a
                                href={facebookLink}
                                className="text-body-color hover:text-primary mx-1 flex h-8 w-8 items-center justify-center"
                            >
                                <svg
                                    width="10"
                                    height="18"
