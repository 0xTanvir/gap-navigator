...
const AboutOurMissionSection = () => {
    return (
        <div className="mx-auto lg:mx-0 max-w-7xl xl:mt-8">
                    ...
                    <div className="lg:w-full lg:max-w-2xl lg:flex-auto">
                        ...
                        <div className="mt-10 max-w-xl text-base leading-7 ">
                            <p>
                                ...
                                tellus varius
                                sit neque erat velit. Faucibus commodo massa rhoncus, volutpat. Dignissim sed eget
                                risus enim.
                            ...
                            <p className="mt-10">
                                ...
                                vulputate et
                                ultrices hac adipiscing egestas. Iaculis convallis ac tempor et ut. Ac lorem vel
                                integer orci.
                            </p>
                        </div>
                    </div>
